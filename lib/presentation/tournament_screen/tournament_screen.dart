...
import 'package:brazilian_perfect/presentation/classification_screen.dart/classification_screen.dart';
...
import 'package:brazilian_perfect/widgets/increment_decrement_field.dart';
...
class _TournamentScreenState extends State<TournamentScreen> {
                    ...
                    child: tournament.players.isEmpty
                        ...
                        : ListView.separated(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              ...
                              Player player = tournament.players[index];
                  ...
                  ConstrainedBox(
                    ...
                    child: tournament.rounds.isEmpty
                        ...
                        : ListView.separated(
                            ...
                            itemBuilder: (BuildContext context, int index) {
                              Round round = tournament.rounds[index];
                              return ExpansionTile(
                                ...
                                children: [
                                  ...
                                  GestureDetector(
                                    ...
                                    child: Container(
                                        color: _selectedIndex == index + 10 * (round.games.length + 1)
                                            ? appTheme.orange900
  ...
  _buildGamesOfCurrentlyRound(Game game, int index, int jindex, bool isBye) {
    return ListTile(
  ...
  _buildShowDialogResult(BuildContext context, Game game) async {
    return showDialog(
  ...
  _buildCustomElevatadeButtonResult(BuildContext context, Game game, result) {
    var width = 48.h;
    String res;
