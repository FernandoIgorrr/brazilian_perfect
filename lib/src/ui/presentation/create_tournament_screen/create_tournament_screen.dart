...
import 'package:brazilian_perfect/src/ui/presentation/create_tournament_screen/sucess_tournament_creation_screen.dart';
...
import 'package:brazilian_perfect/src/ui/widgets/custom_radio_choice.dart';
...
class _CreateTournamentScreenState extends State<CreateTournamentScreen> {
  ...
  _createTournament() async {
    ...
    tournamentManager
        .createTournament(TournamentModel.toTourmament(tournament));
